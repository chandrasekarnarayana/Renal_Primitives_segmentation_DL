...
img_transform = transforms.Compose([
    ...
    transforms.RandomResizedCrop(size=patch_size,scale=(0.5, 1.3)),
...
for epoch in range(num_epochs):
    ...
    for phase in phases: #iterate through both training and validation states
        ...
        print("size of set: ",len(dataLoader[phase]))
    ...
    if all_loss["val"] < best_loss_on_test:
        ...
        torch.save(state, f"{dataname}_unet_best_model_no_albumentation.pth")
    else:
        print("")
